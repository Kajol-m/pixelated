  ...
  return (
    <div className="">
      <div className="flex flex-col lg:flex-row lg:pt-[50px] md:pt-[50px] pt-[10px] lg:pb-8 md:pb-8 pb-4">
        {/* Left Section */}
        <div className="lg:w-1/2 pl-[20px] pr-[20px]">
        ...
        {/* Right Section */}
        <div className="lg:w-1/2  pl-[20px] pr-[20px] pt-4 md:pt-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full">
            ...
            <Button
              variant="secondary"
              onClick={() => {}}
              className="px-6 md:px-8 py-2 w-full sm:w-auto"
            >
              SUBMIT
            </Button>
          </div>
      ...
      {/* Bottom Note */}
      <p className="text-justify text-xs px-[20px] pb-8">
